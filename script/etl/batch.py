...
import pydeequ
from script.automation.qualityChecking import QualityChecking
...
def spark_session():
    ...
    return initialize.start_spark(spark_config={
...
def main():
    ...
    # initialize qualityChecking
    checking = QualityChecking(spark_session())
    ...
    # verification result
    checking.verification(longest_streak)
